...
public class BlockChain {
    ...
    public static final int MIN_REGISTERING_BALANCE_OWN = 1000;
    ...
    /// default = 0.1%
    public static final BigDecimal ASSET_TRANSFER_PERCENTAGE_DEFAULT = new BigDecimal("0.01");
     ...
     */
    public static final BigDecimal ASSET_BURN_PERCENTAGE_DEFAULT = BigDecimal.ONE; //new BigDecimal("0");
