...
function transactionLite(urlstart, data, i, item) {
    ...
    if (item.transaction.type == 1) // GENESIS_ISSUE_ASSET_TRANSACTION
    {
        ...
        output += '<td>' + addCommas(item.transaction.amount) + ' <font size="-2">RUPAY</font>';
        output += '<br>fee: ' + addCommas(item.transaction.fee) + ' <font size="-2">RUPAY</font></td>';
    ...
    } else if (item.transaction.type == 3) // Name registration
    {
        ...
        output += '<td>' + addCommas(item.transaction.fee) + ' <font size="-2">RUPAY</font>';
    ...
    } else if (item.transaction.type == 5) // Name to Sale
    {
        ...
        output += '<td>' + addCommas(item.transaction.fee) + ' <font size="-2">RUPAY</font></td>';

        output += '<td>' + addCommas(item.transaction.amount) + ' <font size="-2">RUPAY</font></td>';
    ...
    } else if (item.transaction.type == 8) // Poll Creation
    {
        ...
        output += '<td rowspan=2>' + addCommas(item.transaction.fee) + ' <font size="-2">RUPAY</font></td>';
    ...
    } else if (item.transaction.type == 10) // Arbitrary Transaction
    {
        ...
        output += '<b>Action</b></td><td width="290"><b>Creator</b></td><td width=150><b>Fee:</b> ' + addCommas(item.transaction.fee) + ' <font size="-2">RUPAY</font>' + '</td>';
    ...
    } else if (item.transaction.type == 15) // Multi Payment
    {
        ...
        output += 'fee: ' + addCommas(item.transaction.fee) + ' <font size="-2">RUPAY</font></td>';
